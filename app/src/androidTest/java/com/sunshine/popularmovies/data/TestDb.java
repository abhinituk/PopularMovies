...
//        ContentValues detailValues = TestUtilities.createMovieDetailValues(movieRowId);
//
//        // Third Step (Weather): Insert ContentValues into database and get a row ID back
//        long weatherRowId = db.insert(MovieContract.MovieDetailEntry.TABLE_NAME, null, detailValues);
...
//    }
    ...
    private long insertMovie() {
        ...
        // Fifth Step: Validate com.sunshine.popularmovies.data in resulting Cursor with the original ContentValues
